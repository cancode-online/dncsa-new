...
In elementary school, I used Scratch to create a plethora of games. During the summer, I also took ID Tech Camps that taught me more about game design and programming. Though some of these camps weren't _that_ helpful in learning computer science (Minecraft mapping isn't a skill I use to day), they furthered my interest in the subject. You can check out some of my scratch projects [here](https://scratch.mit.edu/users/avo12345/).
