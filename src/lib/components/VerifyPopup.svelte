    ...
    <div id="my-modal" class="self-center flex flex-col justify-center items-center modal-box modal-open gap-4 w-full py-10 px-8">
        ...
        <div class="flex flex-col justify-center gap-8 w-5/6">
            ...
            <div class="form-control w-full">
                ...
                <input type="text" placeholder="Type here" class="input input-bordered w-full" bind:value={first_name_input}/>
            </div>
            ...
            <div class="flex justify-around p-4 w-full">
                <button class="btn btn-ghost self-center text-xs normal-case"on:click={verifyInfoDoNotAsk}>Do Not Ask Again</button>
